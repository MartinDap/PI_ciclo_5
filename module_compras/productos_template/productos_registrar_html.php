                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form method="post">
                                <input type="hidden" name="prod_id" value="<?= $data["Detalles"]['prod_id'] ?>">
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Nombre</label>
                                        <input type="text" name="prod_nombre" placeholder="Nombre del Producto" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="prod_unidad" placeholder="Unidades del Producto" class="form-control">                   
                                    </div>
