                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="prod_id" value="<?= $data["Detalles"]["0"]['prod_id'] ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="pla_comida" class="form-control" value="<?= $data["Detalles"]["0"]['pla_comida'] ?>">            
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1"  class="form-label">Descripción</label>
                                        <input type="text" name="pla_descrip" class="form-control" value="<?= $data["Detalles"]["0"]['pla_descrip'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Precio</label>
                                        <input type="number" name="pla_precio" class="form-control" value="<?= $data["Detalles"]["0"]['pla_precio'] ?>">
                                    </div>                                                                  
