            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Lista de Sucursales</h1>
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="card-body px-0">
                                    <a href="sucursal_registrar_html.php" class="btn btn-primary">Registrar</a>
                                    <a href="../empresa_template/empresa_html.php" class="btn btn-primary">Empresas</a>
                                </div>
                                ...
                                <?php foreach($data["Detalles"] as $sucursal):?>
									<tr>
										...
										<td><?= $sucursal["sucu_departamento"] ?></td>
										<td><?= $sucursal["sucu_provincia"] ?></td>
										<td><?= $sucursal["empr_nombre"] ?></td>
                                        <td><a href="sucursal_editar_html.php?sucu_id=<?= $sucursal['sucu_id'] ?>" class="btn "><i class="fa-solid fa-pen-to-square"></i></a></td>
                                        <td><a href="sucursal_eliminar_html.php?sucu_id=<?= $sucursal['sucu_id'] ?>" class="btn"><i class="fas fa-trash" color="#FF0000" ></i></i></a></td>
									</tr>
									<?php endforeach ?>
                                </tbody>
                                </table>
