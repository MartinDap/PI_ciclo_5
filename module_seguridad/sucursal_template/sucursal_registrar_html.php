            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Registrar Sucursal</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form method="post">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="sucu_nombre" class="form-control" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1"  class="form-label">Dirección</label>
                                        <input type="text" name="sucu_direccion" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Telefono</label>
                                        <input type="text" name="sucu_telefono"class="form-control">
                                    </div>
									<div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Departamento</label>
                                        <input type="text" name="sucu_departamento" class="form-control" aria-describedby="emailHelp">
                                    </div>
									<div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Provincia</label>
                                        <input type="text" name="sucu_provincia" class="form-control" aria-describedby="emailHelp">
                                    </div>
									<div class="mb-3">
