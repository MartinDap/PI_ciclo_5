                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="card-body px-0">
                                    <a href="empresa_registrar_html.php" class="btn btn-primary">Registrar</a>
                                    <a href="../sucursal_template/sucursal_html.php" class="btn btn-primary">Sucursales</a>
                                </div>
                                ...
                                <table  class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="empresa_editar_html.php?empr_id=<?= $empresa['empr_id'] ?>" class="btn "><i class="fa-solid fa-pen-to-square"></i></a></td>
											<td><a href="empresa_eliminar_html.php?empr_id=<?= $empresa['empr_id'] ?>" class="btn"><i class="fas fa-trash" color="#FF0000" ></i></i></a></td>
										</tr>
										<?php endforeach ?>
									</tbody>
                                </table>
