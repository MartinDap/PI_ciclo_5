<?php 
	if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        CURLOPT_URL => 'https://cevicherias.informaticapp.com/empresa/'.$_POST['empr_id'],
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Modificar Empresa "<?= $data["Detalles"]['empr_nombre'] ?>"</h1>
                        <div class="card mb-4">
                            <div class="card-body">

                                <form method="post">
                                    <div class="mb-3">
                                        <input type="hidden" name="empr_id" name="empr_id" value="<?= $data["Detalles"]['empr_id'] ?>">
                                        <label for="exampleInputEmail1" class="form-label">Nombre</label>
                                        <input type="text" name="empr_nombre" value="<?= $data["Detalles"]['empr_nombre'] ?>" class="form-control" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1"  class="form-label">Telefono</label>
                                        <input type="text" name="empr_telefono" value="<?= $data["Detalles"]['empr_telefono'] ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Correo</label>
                                        <input type="text" name="empr_correo" value="<?= $data["Detalles"]['empr_correo'] ?>" class="form-control">
                                    </div>
