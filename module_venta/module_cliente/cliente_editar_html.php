<?php 
	if($_SERVER["REQUEST_METHOD"]=="POST"){
		...
		curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://cevicherias.informaticapp.com/clientes/'.$_GET['cli_id'],
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 0,
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Modificar Tipo "<?= $data["Detalles"][0]['per_nombres'] ?>"</h1>
                        <div class="card mb-4">
                            <div class="card-body">

                                <form method="post">
                                    <div class="mb-3">
                                        <input type="hidden" name="cli_id" value="<?= $data["Detalles"][0]['cli_id'] ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="per_apellidos" value="<?= $data["Detalles"][0]['per_apellidos'] ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Telefono</label>
                                        <input type="text" name="per_telefono" value="<?= $data["Detalles"][0]['per_telefono'] ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">DNI</label>
                                        <input type="text" name="per_dni" value="<?= $data["Detalles"][0]['per_dni'] ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Correo</label>
                                        <input type="text" name="per_correo" value="<?= $data["Detalles"][0]['per_correo'] ?>" class="form-control">
                                    </div>
                                    <button type="submit" class="btn btn-primary">Actualizar</button>
                                    <a href="cliente_html.php" class="btn btn-danger">Cancelar</a>
                                </form>
                            </div>
                        </div>
                    </div>
