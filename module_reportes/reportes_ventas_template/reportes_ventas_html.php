...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://cevicherias.informaticapp.com/boletas',
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
																		<?php foreach($data["Detalles"] as $reporte_ventas):?>
																		<tr>
																			<td><?= $reporte_ventas["bol_fech_emision"] ?></td>
																			<td><?= $reporte_ventas["depe_num_mesa"] ?></td>
																			<td><?= $reporte_ventas["bol_monto_total"] ?></td>
																		</tr>
																		<?php endforeach ?>
																	</tbody>
                              </table>
