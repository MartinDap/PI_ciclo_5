            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Reporte de Pedidos</h1>
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <table class="table">
                                  <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">Precio de plato</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <?php foreach($data["Detalles"] as $reportes_pedidos):?>
                                    <tr>
                                        <td><?= $reportes_pedidos["ped_id"] ?></td>
                                        <td><?= $reportes_pedidos["ped_tipo_compra"] ?></td>
                                        <td><?= $reportes_pedidos["pla_comida"] ?></td>
                                        <td><?= $reportes_pedidos["pla_precio"] ?></td>
                                    </tr>
                                    <?php endforeach ?>
                                  </tbody>
                              </table>
